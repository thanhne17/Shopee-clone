        ...
        <header className="header sticky top-0 z-50">
            <div className="grids">
                <nav className="header__navbar">
                    <ul className="headear__navbar--list">
                        <li className="header__navbar--item header__navbar--item--separate">
                            Vào cửa hàng trên ứng dụng F8-shop
                            <div className="header--qr z-10 shadow-xl">
                                <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/d91264e165ed6facc6178994d5afae79.png" alt="QR CODE" className="header__pr-img" />
                                <div className="header__qr-apps">
                                    <a href="" className="header__qr-link"><img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/39f189e19764dab688d3850742f13718.png" alt="" className="header__qr-download--img" /></a>
                                    <a href="" className="header__qr-link"><img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/f4f5426ce757aea491dce94201560583.png" alt="" className="header__qr-download--img" /></a>
                                </div>
                            </div>
                        </li>
                        <li className="header__navbar--item">
                            <span className="header__navbar--title--no-pointer">Kết nối</span>
                            <a href="" className="header__navbar--item--link"><i className="header__navbar--icon fa-brands fa-facebook"></i></a>
                            <a href="" className="header__navbar--item--link"><i className="header__navbar--icon fa-brands fa-instagram"></i></a>
                        </li>
                    </ul>
                    <ul className="headear__navbar--list flex items-center">
                        <li className="header__navbar--item">
                            <a className="header__navbar--item-link">
                                <i className="header__navbar--icon fa-solid fa-bell"></i>
                                Thông báo
                            </a>
                            <div className="header__notify z-10 shadow-xl">
